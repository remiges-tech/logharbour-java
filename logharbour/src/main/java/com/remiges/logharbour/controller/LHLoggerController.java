...
public class LHLoggerController {
	...
	public List<LogEntry> getChanges(@RequestParam String queryToken, @RequestParam String app,
			@RequestParam(required = false) String who, @RequestParam String className, @RequestParam String instance,
	...
	public GetLogsResponse getLogs(@RequestParam(required = true) String queryToken,
			@RequestParam(required = false) String app, @RequestParam(required = false) String who,
			@RequestParam(required = false) String className, @RequestParam(required = false) String instance,
			@RequestParam(required = false) String op,
			@RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) String fromts,
			@RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) String tots,
			@RequestParam(required = false, defaultValue = "0") int ndays,
			@RequestParam(required = false) String logType, @RequestParam(required = false) String remoteIP,
	 ...
	 */
	@PostMapping("/getlogs")
	public Map<String, Integer> getSet(@RequestParam(required = true) String queryToken,
			@RequestParam(required = true) String app, @RequestParam(required = false) String type,
			...
			@RequestParam(required = false) LogPri_t pri, @RequestParam(required = true) String setattr)
			throws Exception {

		logHarbour.getSetlogs(convertRequestParamToRequestForm(queryToken, app, type, who, clazz, instance, op, fromts,
